...
#ifndef MyG4RadioactiveDecay_h
#define MyG4RadioactiveDecay_h 1
...
class G4Fragment;
class MyG4RadioactiveDecayMessenger;
class G4PhotonEvaporation;

typedef std::map<G4String, G4DecayTable*> DecayTableMap;


class MyG4RadioactiveDecay : public G4VRestDiscreteProcess{
  // class description
  ...
  public: // with description
    ...
    MyG4RadioactiveDecay(const G4String& processName="RadioactiveDecay");
    ~MyG4RadioactiveDecay();

    G4double last_delta=0;
  ...
  protected:
    ...
    MyG4RadioactiveDecayMessenger* theRadioactiveDecayMessenger;
  ...
  private:
    ...
    MyG4RadioactiveDecay(const MyG4RadioactiveDecay& right);
    MyG4RadioactiveDecay& operator=(const MyG4RadioactiveDecay& right);
