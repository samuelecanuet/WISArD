...
class MyG4RadioactiveDecay;

class MyG4RadioactiveDecayMessenger: public G4UImessenger
{
  public: //with description
    MyG4RadioactiveDecayMessenger(MyG4RadioactiveDecay* theRadioactiveDecayContainer);
    ~MyG4RadioactiveDecayMessenger();

    void SetNewValue (G4UIcommand *command, G4String newValues);

  private:
    MyG4RadioactiveDecay* theRadioactiveDecayContainer;
